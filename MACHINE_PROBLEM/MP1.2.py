...
def lab_access_rule(student_name):
    ...
    safety_gear = input("Is the safety gear worn? (T/F): ").strip().upper() == "T"
    access_granted = safety_gear  # Access only if safety gear is worn
...
def main():
    ...
    while True:
        ...
        match choice:
            ...
            case "5": lab_access_rule(student_name)
            case "6":
